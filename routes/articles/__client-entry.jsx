...
/*
  ...
  Main client entry point for Encapsule Platform snapsite route '4ce2db12'.
  This script will be called when the HTML5 document published at
  URL 'http://encapsule.github.io/articles' loads in your browser.
...
console.log("snapsite client app initializing on route '/articles'...");
console.log("Page [Encapsule Platform :: Articles] (4ce2db12) Copyright (C) 2016 Encapsule.io");
