...
/*
  ...
  Main client entry point for Encapsule Project snapsite route '4ce2db12'.
...
console.log("Page [Encapsule Project :: Articles] (4ce2db12) Copyright (C) 2016 Encapsule.io");
