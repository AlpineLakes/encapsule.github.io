...
/*
  ...
  Main client entry point for Encapsule Platform snapsite route '8d14a764'.
  This script will be called when the HTML5 document published at
  URL 'http://encapsule.github.io/projects/arc/arctools' loads in your browser.
...
console.log("snapsite client app initializing on route '/projects/arc/arctools'...");
console.log("Page [Encapsule Platform :: ARCtools] (8d14a764) Copyright (C) 2016 Encapsule.io");
