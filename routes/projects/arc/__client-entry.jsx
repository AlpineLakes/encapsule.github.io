...
/*
  ...
  Main client entry point for Encapsule Platform snapsite route 'd7df211a'.
  This script will be called when the HTML5 document published at
  URL 'http://encapsule.github.io/projects/arc' loads in your browser.
...
console.log("snapsite client app initializing on route '/projects/arc'...");
console.log("Page [Encapsule Platform :: ARC] (d7df211a) Copyright (C) 2016 Encapsule.io");
