...
/*
  ...
  Server UX render entry entry point for Encapsule Platform snapsite route '1ef8a04c'.
...
module.exports = function() {
    ...
    while (!inBreakScope) {
        ...
        try {
            ...
            errors.unshift("Failed to render '/projects/arc/arccore/graph' due to error:");
            break;
        }
        break;
    }
