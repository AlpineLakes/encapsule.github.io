...
/*
  ...
  Main client entry point for Encapsule Platform snapsite route '1ef8a04c'.
  This script will be called when the HTML5 document published at
  URL 'http://encapsule.github.io/projects/arc/arccore/graph' loads in your browser.
...
console.log("snapsite client app initializing on route '/projects/arc/arccore/graph'...");
console.log("Page [Encapsule Platform :: graph] (1ef8a04c) Copyright (C) 2016 Encapsule.io");
