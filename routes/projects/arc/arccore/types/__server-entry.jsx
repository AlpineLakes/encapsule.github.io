...
/*
  ...
  Server UX render entry entry point for Encapsule Platform snapsite route 'cd5652f2'.
...
module.exports = function() {
    ...
    while (!inBreakScope) {
        ...
        try {
            ...
            errors.unshift("Failed to render '/projects/arc/arccore/types' due to error:");
            break;
        }
        break;
    }
