...
/*
  ...
  Main client entry point for Encapsule Platform snapsite route 'cd5652f2'.
  This script will be called when the HTML5 document published at
  URL 'http://encapsule.github.io/projects/arc/arccore/types' loads in your browser.
...
console.log("snapsite client app initializing on route '/projects/arc/arccore/types'...");
console.log("Page [Encapsule Platform :: types] (cd5652f2) Copyright (C) 2016 Encapsule.io");
