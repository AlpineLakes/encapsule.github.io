...
/*
  ...
  Main client entry point for Encapsule Platform snapsite route 'abd001a2'.
  This script will be called when the HTML5 document published at
  URL 'http://encapsule.github.io/projects/arc/arccore/discriminator' loads in your browser.
...
console.log("snapsite client app initializing on route '/projects/arc/arccore/discriminator'...");
console.log("Page [Encapsule Platform :: discriminator] (abd001a2) Copyright (C) 2016 Encapsule.io");
...
const clientAppEntry = require('/usr/local/lib/node_modules/snapsite/bin/rtlib/default-client-extension');
