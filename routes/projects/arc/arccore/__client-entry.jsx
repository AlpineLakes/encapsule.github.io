...
/*
  ...
  Main client entry point for Encapsule Platform snapsite route '4dff70b0'.
  This script will be called when the HTML5 document published at
  URL 'http://encapsule.github.io/projects/arc/arccore' loads in your browser.
...
console.log("snapsite client app initializing on route '/projects/arc/arccore'...");
console.log("Page [Encapsule Platform :: ARCcore] (4dff70b0) Copyright (C) 2016 Encapsule.io");
