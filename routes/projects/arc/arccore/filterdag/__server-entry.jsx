...
/*
  ...
  Server UX render entry entry point for Encapsule Platform snapsite route 'fae1ae53'.
...
module.exports = function() {
    ...
    while (!inBreakScope) {
        ...
        try {
            ...
            errors.unshift("Failed to render '/projects/arc/arccore/filterdag' due to error:");
            break;
        }
        break;
    }
