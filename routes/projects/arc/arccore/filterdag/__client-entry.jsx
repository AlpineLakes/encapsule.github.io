...
/*
  ...
  Main client entry point for Encapsule Platform snapsite route 'fae1ae53'.
  This script will be called when the HTML5 document published at
  URL 'http://encapsule.github.io/projects/arc/arccore/filterdag' loads in your browser.
...
console.log("snapsite client app initializing on route '/projects/arc/arccore/filterdag'...");
console.log("Page [Encapsule Platform :: filterDAG] (fae1ae53) Copyright (C) 2016 Encapsule.io");
