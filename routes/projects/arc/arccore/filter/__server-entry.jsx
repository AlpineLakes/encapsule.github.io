...
/*
  ...
  Server UX render entry entry point for Encapsule Platform snapsite route 'eed1371a'.
...
module.exports = function() {
    ...
    while (!inBreakScope) {
        ...
        try {
            ...
            errors.unshift("Failed to render '/projects/arc/arccore/filter' due to error:");
            break;
        }
        break;
    }
