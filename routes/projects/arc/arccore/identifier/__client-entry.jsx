...
/*
  ...
  Main client entry point for Encapsule Platform snapsite route '14b06ea1'.
  This script will be called when the HTML5 document published at
  URL 'http://encapsule.github.io/projects/arc/arccore/identifier' loads in your browser.
...
console.log("snapsite client app initializing on route '/projects/arc/arccore/identifier'...");
console.log("Page [Encapsule Platform :: identifier] (14b06ea1) Copyright (C) 2016 Encapsule.io");
