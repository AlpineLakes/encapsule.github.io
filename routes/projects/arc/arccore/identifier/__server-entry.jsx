...
/*
  ...
  Server UX render entry entry point for Encapsule Platform snapsite route '14b06ea1'.
...
module.exports = function() {
    ...
    while (!inBreakScope) {
        ...
        try {
            ...
            errors.unshift("Failed to render '/projects/arc/arccore/identifier' due to error:");
            break;
        }
        break;
    }
