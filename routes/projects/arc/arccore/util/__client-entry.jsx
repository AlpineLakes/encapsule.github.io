...
/*
  ...
  Main client entry point for Encapsule Platform snapsite route '97c19bf1'.
  This script will be called when the HTML5 document published at
  URL 'http://encapsule.github.io/projects/arc/arccore/util' loads in your browser.
...
console.log("snapsite client app initializing on route '/projects/arc/arccore/util'...");
console.log("Page [Encapsule Platform :: util] (97c19bf1) Copyright (C) 2016 Encapsule.io");
