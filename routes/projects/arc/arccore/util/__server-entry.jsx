...
/*
  ...
  Server UX render entry entry point for Encapsule Platform snapsite route '97c19bf1'.
...
module.exports = function() {
    ...
    while (!inBreakScope) {
        ...
        try {
            ...
            errors.unshift("Failed to render '/projects/arc/arccore/util' due to error:");
            break;
        }
        break;
    }
