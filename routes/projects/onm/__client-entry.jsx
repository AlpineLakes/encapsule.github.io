...
/*
  ...
  Main client entry point for Encapsule Platform snapsite route '80bb5028'.
  This script will be called when the HTML5 document published at
  URL 'http://encapsule.github.io/projects/onm' loads in your browser.
...
console.log("snapsite client app initializing on route '/projects/onm'...");
console.log("Page [Encapsule Platform :: onm] (80bb5028) Copyright (C) 2016 Encapsule.io");
