...
/*
  ...
  Main client entry point for Encapsule Project snapsite route 'aad5552c'.
...
console.log("Page [Encapsule Project :: jsgraph] (aad5552c) Copyright (C) 2016 Encapsule.io");
