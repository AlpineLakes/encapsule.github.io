...
/*
  ...
  Main client entry point for Encapsule Platform snapsite route '77727df7'.
  This script will be called when the HTML5 document published at
  URL 'http://encapsule.github.io/projects' loads in your browser.
...
console.log("snapsite client app initializing on route '/projects'...");
console.log("Page [Encapsule Platform :: Projects] (77727df7) Copyright (C) 2016 Encapsule.io");
